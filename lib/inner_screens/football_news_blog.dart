...
class FootballNewsDetails extends StatefulWidget {
  static const routeName = "/FootballNewsDetails";
  const FootballNewsDetails({Key? key}) : super(key: key);

  @override
  State<FootballNewsDetails> createState() => _FootballNewsDetailsState();
}
...
class _FootballNewsDetailsState extends State<FootballNewsDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final footballNewsProvider = Provider.of<FootballNewsProvider>(context);
    ...
    final currentNews = footballNewsProvider.findById(id: newsId);
