...
class OtherNewsDetails extends StatefulWidget {
  static const routeName = "/OtherNewsDetails";
  const OtherNewsDetails({Key? key}) : super(key: key);

  @override
  State<OtherNewsDetails> createState() => _OtherNewsDetailsState();
}
