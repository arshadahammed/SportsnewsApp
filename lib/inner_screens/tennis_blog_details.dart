...
class TennisNewsDetails extends StatefulWidget {
  static const routeName = "/TennisNewsDetails";
  const TennisNewsDetails({Key? key}) : super(key: key);

  @override
  State<TennisNewsDetails> createState() => _TennisNewsDetailsState();
}
