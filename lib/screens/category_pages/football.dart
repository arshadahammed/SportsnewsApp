...
class FootballNews extends StatefulWidget {
  const FootballNews({super.key});

  @override
  State<FootballNews> createState() => _FootballNewsState();
}
...
class _FootballNewsState extends State<FootballNews> {
  ...
  Widget build(BuildContext context) {
    ...
    final newsProvider = Provider.of<FootballNewsProvider>(context);
        ...
        child: Column(
          children: [
            ...
            FutureBuilder<List<NewsModel>>(
                future: newsProvider.fetchFootballNews(),
